        ...
        if (
          ...
          if (legInfo[i].OriginatedLegs) {
            ...
            if (legsUnformattedList && legsUnformattedList.length > 0) {
              ...
              GetSpecificLegsForTransfer(
                legUuid,
                cdrListArr,
                legInfo[i],
                function (err, transInfLegRes) {
                  current++;
...
var GetSpecificLegsForTransfer = function (
  legUuid,
  cdrListArr,
  legInfo,
  callback
          ...
          if (
            ...
            if (legInfo.OriginatedLegs) {
              ...
              if (legsUnformattedList && legsUnformattedList.length > 0) {
                ...
                backendHandler.GetSpecificLegByUuid(legUuid, function (
                  err,
                  transferLeg
                ) {
                  cdrListArr.push(legInfo);
...
server.get(
  "/DVP/API/:version/CallCDR/GetAbandonCallDetailsByRange",
  ...
  function (req, res, next) {
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetAbandonCallDetailsByRange] - [%s] - HTTP Request Received - Params - StartTime : %s, EndTime : %s, Offset: %s, Limit : %s",
        reqId,
        startTime,
        endTime,
        offset,
      ...
      backendHandler.GetAbandonCallRelatedLegsInDateRange(
        startTime,
        endTime,
        companyId,
        tenantId,
        ...
        function (err, legs) {
          if (err) {
            logger.error(
              "[DVP-CDRProcessor.GetAbandonCallDetailsByRange] - [%s] - Exception occurred on method GetCallRelatedLegsInDateRange",
              reqId,
              err
            );
          } else {
            logger.debug(
              "[DVP-CDRProcessor.GetAbandonCallDetailsByRange] - [%s] - Get call cdr details by date success",
              reqId
            );
          }
          ...
          ProcessCDRLegs(processedCdr, cdrList, function (err, resp) {
            logger.debug(
              "[DVP-CDRProcessor.GetAbandonCallDetailsByRange] - [%s] - CDR Processing Done",
              reqId
            );
      ...
      logger.error(
        "[DVP-CDRProcessor.GetAbandonCallDetailsByRange] - [%s] - Exception occurred",
        reqId,
        ex
      );
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetAbandonCallDetailsByRange] - [%s] - API RESPONSE : %s",
        reqId,
        jsonString
      );
      res.end(jsonString);
...
server.get(
  "/DVP/API/:version/CallCDR/GetAbandonCallDetailsByRange/Count",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetAbandonCallDetailsByRangeCount] - [%s] - HTTP Request Received - Params - StartTime : %s, EndTime : %s",
        reqId,
        startTime,
        endTime
      );

      backendHandler.GetAbandonCallRelatedLegsInDateRangeCount(
        startTime,
        endTime,
        companyId,
        tenantId,
      ...
      logger.error(
        "[DVP-CDRProcessor.GetAbandonCallDetailsByRangeCount] - [%s] - Exception occurred",
        reqId,
        ex
      );
      var jsonString = messageFormatter.FormatMessage(ex, "ERROR", false, 0);
      logger.debug(
        "[DVP-CDRProcessor.GetAbandonCallDetailsByRangeCount] - [%s] - API RESPONSE : %s",
        reqId,
        jsonString
      );
      res.end(jsonString);
...
server.get(
  "/DVP/API/:version/CallCDR/PrepareDownloadAbandon",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.PrepareDownloadAbandon] - [%s] - HTTP Request Received - Params - StartTime : %s, EndTime : %s, Offset: %s, Limit : %s",
        reqId,
        startTime,
        endTime,
        offset,
      ...
      fileCheckAndDelete(reqId, fileName, companyId, tenantId)
        .then(function (chkResult) {
          if (chkResult) {
            externalApi.FileUploadReserve(
              reqId,
              fileName,
              companyId,
              tenantId,
              function (err, fileResResp) {
                if (err) {
                  var jsonString = messageFormatter.FormatMessage(
                    err,
                    "ERROR",
                  ...
                  logger.debug(
                    "[DVP-CDRProcessor.PrepareDownloadAbandon] - [%s] - API RESPONSE : %s",
                    reqId,
                    jsonString
                  );
                  res.end(jsonString);
                  ...
                  if (fileResResp) {
                    ...
                    backendHandler.GetProcessedCDRInDateRangeAbandon(
                      startTime,
                      endTime,
                      companyId,
                      tenantId,
                      ...
                      function (err, cdrList) {
                        logger.debug(
                          "[DVP-CDRProcessor.PrepareDownloadAbandon] - [%s] - CDR Processing Done",
                          reqId
                        );
                        ...
                        if (err) {
                          ...
                          externalApi.DeleteFile(
                            ...
                            function (err, delData) {
                              if (err) {
                                logger.error(
                                  "[DVP-CDRProcessor.PrepareDownloadAbandon] - [%s] - Delete Failed : %s",
                                  reqId,
                                  err
                                );
                              }
                          ...
                          if (cdrList && cdrList.length > 0) {
                            cdrList.forEach(function (cdrProcessed) {
                              cdrProcessed.BillSec = convertToMMSS(
                                cdrProcessed.BillSec
                              );
                              cdrProcessed.Duration = convertToMMSS(
                                cdrProcessed.Duration
                              );
                              cdrProcessed.AnswerSec = convertToMMSS(
                                cdrProcessed.AnswerSec
                              );
                              cdrProcessed.QueueSec = convertToMMSS(
                                cdrProcessed.QueueSec
                              );
                              cdrProcessed.HoldSec = convertToMMSS(
                                cdrProcessed.HoldSec
                              );
                    ...
                    var jsonString = messageFormatter.FormatMessage(
                      new Error("Failed to reserve file"),
                      "ERROR",
                      false,
                      null
                    );
      ...
      logger.error(
        "[DVP-CDRProcessor.PrepareDownloadAbandon] - [%s] - Exception occurred",
        reqId,
        ex
      );
      var jsonString = messageFormatter.FormatMessage(
...
server.get(
  "/DVP/API/:version/CallCDR/TimeZones",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetTimeZones] - [%s] - API RESPONSE : %s",
        reqId,
        jsonString
      );
      res.end(jsonString);
...
var getProcessedCampaignCDRPageWise = function (
  reqId,
  uniqueId,
  fileName,
  tz,
  ...
  var newLine = "\r\n";
  backendHandler.GetProcessedCampaignCDRInDateRange(
    startTime,
    endTime,
    companyId,
    tenantId,
...
var getProcessedCDRPageWise = function (
  reqId,
  uniqueId,
  fileName,
  tz,
  ...
  var newLine = "\r\n";
  backendHandler.GetProcessedCDRInDateRange(
    startTime,
    endTime,
    companyId,
    tenantId,
...
server.get(
  "/DVP/API/:version/CallCDR/PrepareDownload",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.DownloadCDR] - [%s] - HTTP Request Received - Params - StartTime : %s, EndTime : %s, Offset: %s, Limit : %s",
        reqId,
        startTime,
        endTime,
        offset,
      ...
      redisHandler.GetSetObject(fileCheckKey, true, function (err, redisResp) {
        if (redisResp) {
          jsonString = messageFormatter.FormatMessage(
            new Error("Another user generating same file, please try again"),
            "ERROR",
            false,
            null
          );
          logger.debug(
            "[DVP-CDRProcessor.DownloadCDR] - [%s] - API RESPONSE : %s",
            reqId,
            jsonString
          );
          res.end(jsonString);
                  ...
                  function (err, fileResResp) {
                    if (err) {
                      ...
                      if (fileResResp) {
                        ...
                        backendHandler.GetProcessedCDRInDateRangeCount(
                          startTime,
                          endTime,
                          companyId,
                          tenantId,
                                ...
                                if (err) {
                                  ...
                                  externalApi.DeleteFile(
                                    ...
                                    function (err, delData) {
                                      if (err) {
                                        logger.error(
                                          "[DVP-CDRProcessor.DownloadCDR] - [%s] - Delete Failed : %s",
                                          reqId,
                                          err
                                        );
                                      }
      ...
      logger.error(
        "[DVP-CDRProcessor.DownloadCDR] - [%s] - Exception occurred",
        reqId,
        ex
      );
...
server.get(
  "/DVP/API/:version/CallCDR/PrepareDownloadCampaign",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
                  ...
                  function (err, fileResResp) {
                    if (err) {
                      ...
                      if (fileResResp) {
                        ...
                        backendHandler.GetProcessedCampaignCDRInDateRangeCount(
                          startTime,
                          endTime,
                          companyId,
                          tenantId,
                          ...
                          function (err, cnt) {
                            if (!err && cnt) {
                              ...
                              while (cnt > offset) {
                                arr.push(
                                  getProcessedCampaignCDRPageWise.bind(
                                    this,
                                    reqId,
                                    uniqueId,
                                    fileName,
...
server.post(
  "/DVP/API/:version/CallCDR/GeneratePreviousDay",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "write" }),
  function (req, res, next) {
    var reqId = nodeUuid.v1();
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GeneratePreviousDay] - [%s] - HTTP Request Received",
        reqId
      );
      ...
      backendHandler.GetProcessedCDRInDateRange(
        ...
        function (err, cdrList) {
          logger.debug(
            "[DVP-CDRProcessor.GeneratePreviousDay] - [%s] - CDR Processing Done",
            reqId
          );
          ...
          if (err) {
            ...
            logger.debug(
              "[DVP-CDRProcessor.GeneratePreviousDay] - [%s] - API RESPONSE : %s",
              reqId,
              jsonString
            );
            res.end(jsonString);
            ...
            if (cdrList && cdrList.length > 0) {
              ...
              jsonString = messageFormatter.FormatMessage(
                new Error("No CDR Records Found"),
                "ERROR",
                false,
                false
              );
...
server.post(
  "/DVP/API/:version/CallCDR/Abandon/GeneratePreviousDay",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "write" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GeneratePreviousDayAbandon] - [%s] - HTTP Request Received - Params - StartTime : %s, EndTime : %s",
        reqId,
        startDay,
        endDay
      );
      ...
      backendHandler.GetProcessedCDRInDateRangeAbandon(
        ...
        function (err, cdrList) {
          logger.debug(
            "[DVP-CDRProcessor.GeneratePreviousDayAbandon] - [%s] - CDR Processing Done",
            reqId
          );
      ...
      logger.error(
        "[DVP-CDRProcessor.GeneratePreviousDayAbandon] - [%s] - Exception occurred",
        reqId,
        ex
      );
      var jsonString = messageFormatter.FormatMessage(
      ...
      logger.debug(
        "[DVP-CDRProcessor.GeneratePreviousDayAbandon] - [%s] - API RESPONSE : %s",
        reqId,
        jsonString
      );
      res.end(jsonString);
...
server.get(
  "/DVP/API/:version/CallCDR/GetProcessedCallDetailsByRange",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetProcessedCallDetailsByRange] - [%s] - HTTP Request Received - Params - StartTime : %s, EndTime : %s",
        reqId,
        startTime,
        endTime
      );
      ...
      backendHandler.GetProcessedCDRInDateRange(
        ...
        function (err, cdrList) {
          logger.debug(
            "[DVP-CDRProcessor.GetProcessedCallDetailsByRange] - [%s] - CDR Processing Done",
            reqId
          );
          ...
          if (err) {
            ...
            logger.debug(
              "[DVP-CDRProcessor.GetProcessedCallDetailsByRange] - [%s] - API RESPONSE : %s",
              reqId,
              jsonString
            );
            res.end(jsonString);
            ...
            logger.debug(
              "[DVP-CDRProcessor.GetProcessedCallDetailsByRange] - [%s] - API RESPONSE : SUCCESS",
              reqId
            );
            res.end(jsonString);
          }
      ...
      logger.error(
        "[DVP-CDRProcessor.GetProcessedCallDetailsByRange] - [%s] - Exception occurred",
        reqId,
        ex
      );
      var jsonString = messageFormatter.FormatMessage(
...
server.get(
  "/DVP/API/:version/CallCDR/GetCallDetailsByRange",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetCallDetailsByRange] - [%s] - HTTP Request Received - Params - StartTime : %s, EndTime : %s, Offset: %s, Limit : %s",
        reqId,
        startTime,
        endTime,
        offset,
      ...
      backendHandler.GetCallRelatedLegsInDateRange(
        startTime,
        endTime,
        companyId,
        tenantId,
        ...
        function (err, legs) {
          if (err) {
            logger.error(
              "[DVP-CDRProcessor.GetCallDetailsByRange] - [%s] - Exception occurred on method GetCallRelatedLegsInDateRange",
              reqId,
              err
            );
          } else {
            logger.debug(
              "[DVP-CDRProcessor.GetCallDetailsByRange] - [%s] - Get call cdr details by date success",
              reqId
            );
          }
          ...
          ProcessCDRLegs(processedCdr, cdrList, function (err, resp) {
            logger.debug(
              "[DVP-CDRProcessor.GetCallDetailsByRange] - [%s] - CDR Processing Done",
              reqId
            );
      ...
      logger.error(
        "[DVP-CDRProcessor.GetCallDetailsByRange] - [%s] - Exception occurred",
        reqId,
        ex
      );
      var jsonString = messageFormatter.FormatMessage(
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetCallDetailsByRange] - [%s] - API RESPONSE : %s",
        reqId,
        jsonString
      );
      res.end(jsonString);
...
server.get(
  "/DVP/API/:version/CallCDR/GetCampaignCallDetailsByRange",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetCampaignCallDetailsByRange] - [%s] - HTTP Request Received - Params - StartTime : %s, EndTime : %s, Offset: %s, Limit : %s",
        reqId,
        startTime,
        endTime,
        offset,
      ...
      backendHandler.GetCampaignCallLegsInDateRange(
        startTime,
        endTime,
        companyId,
        tenantId,
        ...
        function (err, legs) {
          if (err) {
            logger.error(
              "[DVP-CDRProcessor.GetCampaignCallDetailsByRange] - [%s] - Exception occurred on method GetCallRelatedLegsInDateRange",
              reqId,
              err
            );
          } else {
            logger.debug(
              "[DVP-CDRProcessor.GetCampaignCallDetailsByRange] - [%s] - Get call cdr details by date success",
              reqId
            );
          }
          ...
          ProcessCDRLegs(processedCdr, cdrList, function (err, resp) {
            logger.debug(
              "[DVP-CDRProcessor.GetCampaignCallDetailsByRange] - [%s] - CDR Processing Done",
              reqId
            );
      ...
      logger.error(
        "[DVP-CDRProcessor.GetCampaignCallDetailsByRange] - [%s] - Exception occurred",
        reqId,
        ex
      );
      var jsonString = messageFormatter.FormatMessage(
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetCampaignCallDetailsByRange] - [%s] - API RESPONSE : %s",
        reqId,
        jsonString
      );
      res.end(jsonString);
...
server.get(
  "/DVP/API/:version/CallCDR/GetCampaignCallDetailsByRange/Count",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetCampaignCallDetailsByRangeCount] - [%s] - HTTP Request Received - Params - StartTime : %s, EndTime : %s",
        reqId,
        startTime,
        endTime
      );

      backendHandler.GetCampaignCallLegsInDateRangeCount(
        startTime,
        endTime,
        companyId,
        tenantId,
        ...
        custNum,
        campaignName,
        function (err, cdrCount) {
          var jsonString = "";
          if (err) {
            logger.error(
              "[DVP-CDRProcessor.GetCampaignCallDetailsByRangeCount] - [%s] - Exception occurred on method GetCallRelatedLegsInDateRange",
              reqId,
              err
            );
            ...
            logger.debug(
              "[DVP-CDRProcessor.GetCampaignCallDetailsByRangeCount] - [%s] - Get call cdr details by date success",
              reqId
            );
      ...
      logger.error(
        "[DVP-CDRProcessor.GetCampaignCallDetailsByRangeCount] - [%s] - Exception occurred",
        reqId,
        ex
      );
      var jsonString = messageFormatter.FormatMessage(ex, "ERROR", false, 0);
      logger.debug(
        "[DVP-CDRProcessor.GetCampaignCallDetailsByRangeCount] - [%s] - API RESPONSE : %s",
        reqId,
        jsonString
      );
      res.end(jsonString);
...
server.get(
  "/DVP/API/:version/CallCDR/GetCallDetailsByRange/Count",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetCallDetailsByRangeCount] - [%s] - HTTP Request Received - Params - StartTime : %s, EndTime : %s",
        reqId,
        startTime,
        endTime
      );

      backendHandler.GetCallRelatedLegsInDateRangeCount(
        startTime,
        endTime,
        companyId,
        tenantId,
        ...
        function (err, cdrCount) {
          ...
          if (err) {
            logger.error(
              "[DVP-CDRProcessor.GetCallDetailsByRangeCount] - [%s] - Exception occurred on method GetCallRelatedLegsInDateRange",
              reqId,
              err
            );
            ...
            logger.debug(
              "[DVP-CDRProcessor.GetCallDetailsByRangeCount] - [%s] - Get call cdr details by date success",
              reqId
            );
      ...
      logger.error(
        "[DVP-CDRProcessor.GetCallDetailsByRangeCount] - [%s] - Exception occurred",
        reqId,
        ex
      );
      var jsonString = messageFormatter.FormatMessage(ex, "ERROR", false, 0);
      logger.debug(
        "[DVP-CDRProcessor.GetCallDetailsByRangeCount] - [%s] - API RESPONSE : %s",
        reqId,
        jsonString
      );
      res.end(jsonString);
...
var processSummaryData = function (
  caption,
  startDate,
  endDate,
  companyId,
  ...
  backendHandler.GetCallSummaryDetailsDateRangeWithSkill(
    caption,
    startDate,
    endDate,
    companyId,
    ...
    skill,
    bUnit,
    function (err, summaryData) {
      callback(err, summaryData);
    }
  );
};
var processSummaryDataL = function (
  caption,
  startDate,
  endDate,
  fromHour,
  ...
  backendHandler.GetCallSummaryDetailsDateRangeWithSkillL(
    caption,
    startDate,
    endDate,
    fromHour,
...
server.get(
  ...
  function (req, res, next) {
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetCallCDRSummaryHourly] - [%s] - HTTP Request Received - Params - summaryDate : %s",
        reqId,
        summaryDate
      );
      ...
      async.series(hrFuncArr, function (err, results) {
        if (err) {
          ...
          logger.debug(
            "[DVP-CDRProcessor.GetCallCDRSummaryHourly] - [%s] - API RESPONSE : %s",
            reqId,
            jsonString
          );
          res.end(jsonString);
...
server.get(
  "/DVP/API/:version/CallCDR/CallCDRSummary/Hourly/Download",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetCallCDRSummaryHourlyDownload] - [%s] - HTTP Request Received - Params - summaryDate : %s",
        reqId,
        summaryDate
      );
            ...
            externalApi.FileUploadReserve(
              ...
              function (err, fileResResp) {
                if (err) {
                  ...
                  logger.debug(
                    "[DVP-CDRProcessor.GetCallCDRSummaryHourlyDownload] - [%s] - API RESPONSE : %s",
                    reqId,
                    jsonString
                  );
                  res.end(jsonString);
                      ...
                      if (err) {
                        externalApi.DeleteFile(
                          ...
                          function (err, delData) {
                            if (err) {
                              logger.error(
                                "[DVP-CDRProcessor.GetCallCDRSummaryHourlyDownload] - [%s] - Delete Failed : %s",
                                reqId,
                                err
                              );
                            }
                        ...
                        if (results) {
                          var newSummary = results.map(function (sumr) {
                            ...
                            if (typeof sumr.RingAverage === "number") {
                              sumr.RingAverage = convertToMMSS(
                                sumr.RingAverage
                              );
                            }
...
server.post(
  "/DVP/API/:version/CallCDR/CallCDRSummary/Hourly/GeneratePreviousDay",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "write" }),
  function (req, res, next) {
    var reqId = nodeUuid.v1();
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetCallCDRSummaryHourlyGeneratePreviousDay] - [%s] - HTTP Request Received - Params - summaryDate : %s",
        reqId,
        summaryDate
      );
      ...
      async.series(hrFuncArr, function (err, results) {
        if (err) {
          ...
          logger.debug(
            "[DVP-CDRProcessor.GetCallCDRSummaryHourlyGeneratePreviousDay] - [%s] - API RESPONSE : %s",
            reqId,
            jsonString
          );
          res.end(jsonString);
...
server.get(
  "/DVP/API/:version/CallCDR/CallCDRSummaryByQueue/Hourly",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var reqId = nodeUuid.v1();
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.CallCDRSummaryByQueue] - [%s] - HTTP Request Received - Params - summaryDate : %s",
        reqId,
        summaryDate
      );
      ...
      processSummaryDataL(
        ...
        function (err, result) {
          if (err) {
            ...
            logger.debug(
              "[DVP-CDRProcessor.CallCDRSummaryByQueue] - [%s] - API RESPONSE : %s",
              reqId,
              jsonString
            );
            res.end(jsonString);
...
var getQueueSummaryAsync = function (
  summaryDate,
  tz,
  companyId,
  tenantId,
...
server.post(
  "/DVP/API/:version/CallCDR/CallCDRSummaryByQueue/Hourly/Download",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      if (reportType === "CALL_SUMMARY_QUEUE_HOURLY") {
        ...
        var fileName =
          ...
          fromHour +
          "_" +
          toHour; // only hourly band report has from_hour and to_hour params
      }

      logger.debug(
        "[DVP-CDRProcessor.CallCDRSummaryByQueueDownload] - [%s] - HTTP Request Received - Params - summaryDate : %s",
        reqId,
        summaryDate
      );
              ...
              externalApi.FileUploadReserve(
                ...
                function (err, fileResResp) {
                  if (err) {
                    ...
                    logger.debug(
                      "[DVP-CDRProcessor.CallCDRSummaryByQueueDownload] - [%s] - API RESPONSE : %s",
                      reqId,
                      jsonString
                    );
                    res.end(jsonString);
...
server.get(
  "/DVP/API/:version/CallCDR/CallCDRSummary/Daily",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetCallCDRSummaryHourly] - [%s] - HTTP Request Received - Params - startDate : %s, endDate : %s",
        reqId,
        startDate,
        endDate
      );
      ...
      while (momentSD <= momentED) {
        ...
        dayFuncArr.push(
          processSummaryData.bind(
            this,
            sd.utcOffset(tz).format("YYYY-MM-DD"),
            sd,
            ed,
            companyId,
            tenantId,
...
server.get(
  "/DVP/API/:version/CallCDR/CampaignCallSummary",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var reqId = nodeUuid.v1();
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.CampaignCallSummary] - [%s] - HTTP Request Received - Params - startDate : %s, endDate : %s",
        reqId,
        startDate,
        endDate
      );
      ...
      backendHandler.GetCampaignSummary(
        startDate,
        endDate,
        companyId,
        tenantId,
...
server.get(
  "/DVP/API/:version/CallCDR/CallCDRSummary/Daily/Download",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
...
server.post(
  "/DVP/API/:version/CallCDR/CallCDRSummary/Daily/GeneratePreviousMonth",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "write" }),
  function (req, res, next) {
    var reqId = nodeUuid.v1();
    try {
      ...
      //Create FILE NAME Key
      var fileName =
        "CALL_SUMMARY_DAILY_REPORT_" +
        tenantId +
        "_" +
        companyId +
        "_" +
        startDateMonthComponent;
      ...
      while (momentSD <= momentED) {
        ...
        momentSD = moment(startDay, "YYYY-MM-DD hh:mm:ss Z").add(
          cnt + 1,
          "days"
        );
...
server.post(
  "/DVP/API/:version/CallCDR/AgentStatus",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.AgentStatus] - [%s] - HTTP Request Received - Params - startDate : %s, endDate : %s",
        reqId,
        startDate,
        endDate
      );
      ...
      backendHandler.GetResourceStatusList(
        startDate,
        endDate,
        statusList,
        agentList,
        ...
        function (err, resList) {
          ...
          logger.debug(
            "[DVP-CDRProcessor.AgentStatus] - [%s] - API RESPONSE : %s",
            reqId,
            jsonString
          );
          res.end(jsonString);
...
server.post(
  "/DVP/API/:version/CallCDR/Agent/AgentStatus",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      backendHandler.GetResourceStatusListWithACW(
        startDate,
        endDate,
        statusList,
        agentList,
...
server.post(
  "/DVP/API/:version/CallCDR/Agent/AgentStatus/Download",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      backendHandler.GetResourceStatusListWithACWDownload(
        startDate,
        endDate,
        statusList,
        agentList,
...
server.post(
  "/DVP/API/:version/CallCDR/consolidatedAgent/AgentStatus",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      backendHandler.GetCOnsolidatedResourceStatusListWithACW(
        startDate,
        endDate,
        statusList,
        agentList,
...
server.get(
  "/DVP/API/:version/CallCDR/MyAgentStatus",
  jwt({ secret: secret.Secret }),
  ...
  function (req, res, next) {
    ...
    try {
      ...
      backendHandler.GetMyResourceStatusList(
        startDate,
        endDate,
        req.user.iss,
        companyId,
...
//query_string : ?startTime=2016-05-09&endTime=2016-05-12
server.get(
  "/DVP/API/:version/CallCDR/GetConferenceDetailsByRange",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetConferenceDetailsByRange] - [%s] - HTTP Request Received - Params - StartTime : %s, EndTime : %s, Offset: %s, Limit : %s",
        reqId,
        startTime,
        endTime,
        offset,
      ...
      backendHandler.GetConferenceRelatedLegsInDateRange(
        startTime,
        endTime,
        companyId,
        tenantId,
        ...
        function (err, legs) {
          logger.debug(
            "[DVP-CDRProcessor.GetConferenceDetailsByRange] - [%s] - CDR Processing Done",
            reqId
          );
      ...
      logger.error(
        "[DVP-CDRProcessor.GetConferenceDetailsByRange] - [%s] - Exception occurred",
        reqId,
        ex
      );
      var jsonString = messageFormatter.FormatMessage(
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetConferenceDetailsByRange] - [%s] - API RESPONSE : %s",
        reqId,
        jsonString
      );
      res.end(jsonString);
...
server.get(
  "/DVP/API/:version/CallCDR/GetCallDetailsByApp",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetCallDetailsByAppId] - [%s] - HTTP Request Received - Params - AppId : %s",
        reqId,
        appId
      );

      backendHandler.GetCallRelatedLegsForAppId(
        appId,
        companyId,
        tenantId,
        startTime,
        ...
        function (err, legs) {
          if (err) {
            logger.error(
              "[DVP-CDRProcessor.GetCallDetailsByAppId] - [%s] - Exception occurred on method GetCallRelatedLegsForAppId",
              reqId,
              err
            );
          } else {
            logger.debug(
              "[DVP-CDRProcessor.GetCallDetailsByAppId] - [%s] - Get call related legs for app id success",
              reqId
            );
          }
          ...
          logger.debug(
            "[DVP-CDRProcessor.GetCallDetailsByAppId] - [%s] - API RESPONSE : %s",
            reqId,
            jsonString
          );
          res.end(jsonString);
...
server.get(
  "/DVP/API/:version/CallCDR/GetCallDetailsBySession",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetCallDetails] - [%s] - HTTP Request Received - Params - SessionId : %s",
        reqId,
        sessionId
      );
      ...
      backendHandler.GetCallRelatedLegs(sessionId, function (err, legs) {
        if (err) {
          logger.error(
            "[DVP-CDRProcessor.GetCallDetails] - [%s] - Exception occurred on method GetCallRelatedLegs",
            reqId,
            err
          );
        } else {
          logger.debug(
            "[DVP-CDRProcessor.GetCallDetails] - [%s] - Get call details success",
            reqId
          );
        }
        ...
        logger.debug(
          "[DVP-CDRProcessor.GetCallDetails] - [%s] - API RESPONSE : %s",
          reqId,
          jsonString
        );
        res.end(jsonString);
      ...
      logger.error(
        "[DVP-CDRProcessor.GetCallDetails] - [%s] - Exception occurred",
        reqId,
        ex
      );
      var jsonString = messageFormatter.FormatMessage(
...
server.post(
  "/DVP/API/:version/CallCDR/GetCallDetailsBySessions",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetCallDetailsBySessions] - [%s] - HTTP Request Received",
        reqId
      );
      ...
      backendHandler.GetProcessedCDRForSessions(
        sessionIdList,
        companyId,
        tenantId,
        function (err, result) {
  ...
  cdrList.forEach(function (cdr) {
    ...
    if (custNumber) {
      if (cdrGroupList[custNumber]) {
        ...
        obj.LastCallTime = moment(cdr.CreatedTime)
          .utcOffset(tz)
          .format("YYYY-MM-DD HH:mm:ss");
      } else {
        var obj = {};
...
server.get(
  "/DVP/API/:version/CallCDR/CallSummaryByCustomerDownload",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.CallSummaryByCustomerDownload] - [%s] - HTTP Request Received - Params - StartTime : %s, EndTime : %s",
        reqId,
        startTime,
        endTime
      );
            ...
            externalApi.FileUploadReserve(
              ...
              function (err, fileResResp) {
                if (err) {
                  ...
                  logger.debug(
                    "[DVP-CDRProcessor.CallSummaryByCustomerDownload] - [%s] - API RESPONSE : %s",
                    reqId,
                    jsonString
                  );
                  res.end(jsonString);
                  ...
                  if (fileResResp) {
                    ...
                    backendHandler.GetProcessedCDRInDateRangeCustomer(
                      startTime,
                      endTime,
                      companyId,
                      tenantId,
                        ...
                        if (err) {
                          externalApi.DeleteFile(
                            ...
                            function (err, delData) {
                              if (err) {
                                logger.error(
                                  "[DVP-CDRProcessor.CallSummaryByCustomerDownload] - [%s] - Delete Failed : %s",
                                  reqId,
                                  err
                                );
                              }
                          ...
                          var cdrCustList = generateCDRListByCustomer(
                            cdrList,
                            tz
                          );
      ...
      logger.error(
        "[DVP-CDRProcessor.CallSummaryByCustomerDownload] - [%s] - Exception occurred",
        reqId,
        ex
      );
      var jsonString = messageFormatter.FormatMessage(
...
server.get(
  "/DVP/API/:version/CallCDR/CallSummaryByCustomer",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.CallSummaryByCustomer] - [%s] - HTTP Request Received - Params - StartTime : %s, EndTime : %s",
        reqId,
        startTime,
        endTime
      );
      ...
      backendHandler.GetProcessedCDRInDateRangeCustomer(
        ...
        function (err, cdrList) {
          if (err) {
            ...
            logger.debug(
              "[DVP-CDRProcessor.CallSummaryByCustomer] - [%s] - API RESPONSE : %s",
              reqId,
              jsonString
            );
            res.end(jsonString);
...
server.post(
  "/DVP/API/:version/CallCDR/MailRecipient/ReportType/:repType",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "write" }),
  function (req, res, next) {
    var reqId = nodeUuid.v1();
    try {
      if (req.body) {
        ...
        logger.debug(
          "[DVP-CDRProcessor.AddMailRecipient] - [%s] - HTTP Request Received - Params",
          reqId
        );

        mongoDbOp
          .getEmailRecipients(companyId, tenantId, reportType)
          .then(function (reciInfo) {
            if (reciInfo) {
              return mongoDbOp.updateEmailRecipientRecord(
                reciInfo._id,
                recipients,
                reportType,
                template,
              ...
              return mongoDbOp.addEmailRecipientRecord(
                recipients,
                reportType,
                template,
                companyId,
          ...
          .then(function (saveUpdateInfo) {
            ...
            logger.debug(
              "[DVP-CDRProcessor.AddMailRecipient] - [%s] - API RESPONSE : %s",
              reqId,
              jsonString
            );
            res.end(jsonString);
...
server.get(
  "/DVP/API/:version/CallCDR/MailRecipients/ReportType/:repType",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetMailRecipient] - [%s] - HTTP Request Received",
        reqId
      );

      mongoDbOp
        .getEmailRecipients(companyId, tenantId, repType)
      ...
      logger.debug(
        "[DVP-CDRProcessor.GetMailRecipient] - [%s] - API RESPONSE : %s",
        reqId,
        jsonString
      );
      res.end(jsonString);
...
server.del(
  "/DVP/API/:version/CallCDR/MailRecipient/:id",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var reqId = nodeUuid.v1();
    try {
      ...
      logger.debug(
        "[DVP-CDRProcessor.DeleteMailRecipient] - [%s] - HTTP Request Received",
        reqId
      );

      backendHandler
        .deleteEmailRecipientRecord(id, companyId, tenantId)
        .then(function (response) {
          var jsonString = messageFormatter.FormatMessage(
            null,
            "SUCCESS",
          ...
          logger.debug(
            "[DVP-CDRProcessor.DeleteMailRecipient] - [%s] - API RESPONSE : %s",
            reqId,
            jsonString
          );
          res.end(jsonString);
...
var sendMail = function (
  ...
  if (
    reportType === "CDR_DAILY_REPORT" ||
    reportType === "ABANDONCDR_DAILY_REPORT" ||
    reportType === "CALL_SUMMARY_HOURLY_REPORT"
  ) {
    var localTime = moment().utcOffset(tz);
  ...
  var httpUrl = util.format(
    "http://%s/DVP/API/%s/InternalFileService/File/DownloadLatest/%d/%d/%s.csv",
    fileServiceHost,
    fileServiceVersion,
    tenantId,
    companyId,
  ...
  if (config.Services.dynamicPort || validator.isIP(fileServiceHost)) {
    httpUrl = util.format(
      "http://%s:%s/DVP/API/%s/InternalFileService/File/DownloadLatest/%d/%d/%s.csv",
      fileServiceHost,
      fileServicePort,
      fileServiceVersion,
      tenantId,
...
server.post(
  "/DVP/API/:version/CallCDR/Report/SendMail",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "write" }),
  function (req, res, next) {
    var reqId = nodeUuid.v1();
    try {
      ...
      mongoDbOp
        .getEmailRecipients(companyId, tenantId, body.reportType)
        .then(function (resp) {
          var jsonString = messageFormatter.FormatMessage(
            null,
            "SUCCESS",
...
server.post("/DVP/API/:version/CallCDR/ProcessCDR", function (req, res, next) {
  ...
  try {
    logger.info(
      "[DVP-CDRProcessor.ProcessCDR] - [%s] - FS CDR Request Received",
      reqId
    );
    var cdrObj = req.body;
    ...
    logger.debug(
      "[DVP-CDRProcessor.ProcessCDR] - [%s] - CDR Request Params : %s",
      reqId,
      rawCDR
    );
    ...
    if (callFlowSec && callFlowSec.length > 0) {
      ...
      if (
        !sipToUser ||
        (actionCat === "FORWARDING" && direction === "inbound")
      ) {
        sipToUser = decodeURIComponent(varSec["sip_to_user"]);
      }

      if (!sipFromUser) {
        sipFromUser = decodeURIComponent(
          varSec["origination_caller_id_number"]
        );
      }
      ...
      backendHandler.AddCDRRecord(cdr, function (err, result) {
        if (err) {
          logger.error(
            "[DVP-CDRProcessor.ProcessCDR] - [%s] - Exception occurred on method AddCDRRecord",
            reqId,
            err
          );
          res.end("{}");
          ...
          logger.debug(
            "[DVP-CDRProcessor.ProcessCDR] - [%s] - CDR Record saved successfully - Result : %s",
            reqId,
            result
          );
          res.end("{}");
      ...
      logger.error(
        "[DVP-CDRProcessor.ProcessCDR] - [%s] - CDR Record Error - Call Flow Section Not Found - Result : %s",
        reqId
      );
      res.end("{}");
    }
    ...
    logger.error(
      "[DVP-CDRProcessor.ProcessCDR] - [%s] - Exception occurred",
      reqId,
      ex
    );
    res.end("{}");
...
server.get(
  "/DVP/API/:version/CallCDR/Processed/GetCallDetailsByRange/Count",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var reqId = nodeUuid.v1();
...
server.get(
  "/DVP/API/:version/CallCDR/Processed/GetCallDetailsByRange",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
...
server.get(
  "/DVP/API/:version/CallCDR/Processed/GetAbandonCallDetailsByRange",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      backendHandler.GetAbandonCallRelatedLegsInDateRangeProcessed(
        startTime,
        endTime,
        companyId,
        tenantId,
...
server.get(
  "/DVP/API/:version/CallCDR/Processed/GetAbandonCallDetailsByRange/Count",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
    ...
    try {
      ...
      backendHandler.GetAbandonCallRelatedLegsInDateRangeProcessedCount(
        startTime,
        endTime,
        companyId,
        tenantId,
...
server.get(
  "/DVP/API/:version/CallCDR/Processed/GetCampaignCallDetailsByRange",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
...
server.get(
  "/DVP/API/:version/CallCDR/Processed/GetCampaignCallDetailsByRange/Count",
  jwt({ secret: secret.Secret }),
  authorization({ resource: "cdr", action: "read" }),
  function (req, res, next) {
    var emptyArr = [];
