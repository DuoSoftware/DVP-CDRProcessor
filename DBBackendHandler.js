...
var GetCallSummaryDetailsDateRangeWithSkillL = function(caption, startTime, endTime, tz, companyId, tenantId, skills, bUnit, callback)
{
    var summaryDetails = {};
    try {
        var st = startTime.toISOString();
        ...
        "SELECT ivrcount, " +
            ...
            {replacements: {fromdate: st, todate: et, skills:skills, timezone:tz, bu:bUnit, company:companyId, tenant: tenantId} }
